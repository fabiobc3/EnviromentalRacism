...
function NitrousOxideEmissions(props){
    ...
    let isData = (data != 0);
    let str = 'Total Nitrous Oxide in CO2 equivalent emissions from facilities in zip ' + zip + ' is ' + data;
...
export default NitrousOxideEmissions;